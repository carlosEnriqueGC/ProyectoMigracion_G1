...
namespace CapaVistaERP.Procesos
{
    public partial class TipodeCambioApi : Form
    {
        ...
        // Sobrescribir método ToString para que el ComboBox muestre solo la descripción
        ...
        private void btnConsultarTipoCambioServicioWebAPI_Click(object sender, EventArgs e)
        {
